...
// Date      : Fri Mar 28 13:23:41 2025
/////////////////////////////////////////////////////////////


module s713 ( CK, G1, G10, G100BF, G101BF, G103BF, G104BF, G105BF, G106BF, 
        G107, G11, G12, G13, G14, G15, G16, G17, G18, G19, G2, G20, G21, G22, 
        G23, G24, G25, G26, G27, G28, G29, G3, G30, G31, G32, G33, G34, G35, 
        G36, G4, G5, G6, G8, G83, G84, G85, G86BF, G87BF, G88BF, G89BF, G9, 
  ...
  output G100BF, G101BF, G103BF, G104BF, G105BF, G106BF, G107, G83, G84, G85,
         G86BF, G87BF, G88BF, G89BF, G90, G91, G92, G94, G95BF, G96BF, G97BF,
         G98BF, G99BF;
  wire   G27, G29, G64, G65, G66, G67, G250, G68, G69, G70, G71, G72, G73, G74,
         G75, G76, G77, G78, G79, G80, G81, G82, G277, G276, G271, G275, G272,
  ...
  sg13g2_nand2_2 U1 ( .A(n15), .B(n21), .Y(\DFF_10/D ) );
  sg13g2_nand2_2 U2 ( .A(G14), .B(\DFF_0/D ), .Y(G103BF) );
  sg13g2_nand2_2 U3 ( .A(n14), .B(n23), .Y(\DFF_8/D ) );
  sg13g2_nand2_2 U4 ( .A(G15), .B(n4), .Y(G104BF) );
  sg13g2_nand2_2 U5 ( .A(n13), .B(n25), .Y(\DFF_6/D ) );
  ...
  sg13g2_nor3_2 U13 ( .A(n8), .B(G11), .C(n35), .Y(n28) );
  sg13g2_nor2_2 U14 ( .A(n5), .B(n2), .Y(n27) );
  sg13g2_nor3_2 U15 ( .A(n39), .B(n4), .C(n40), .Y(G275) );
  sg13g2_nor4_2 U16 ( .A(\DFF_2/D ), .B(\DFF_0/D ), .C(n4), .D(n35), .Y(n42)
         );
  sg13g2_nand2_2 U17 ( .A(G68), .B(n12), .Y(n35) );
  sg13g2_nor4_2 U18 ( .A(\DFF_0/D ), .B(n10), .C(n4), .D(n8), .Y(n45) );
  sg13g2_nor2_2 U19 ( .A(n25), .B(n26), .Y(n34) );
  sg13g2_nand2_2 U20 ( .A(G69), .B(n19), .Y(n26) );
  sg13g2_nand2_2 U21 ( .A(G70), .B(n9), .Y(n25) );
  sg13g2_nor4_2 U22 ( .A(\DFF_2/D ), .B(\DFF_0/D ), .C(n10), .D(n5), .Y(n48)
         );
  sg13g2_nor2_2 U23 ( .A(n23), .B(n24), .Y(n36) );
  sg13g2_nand2_2 U24 ( .A(G71), .B(n19), .Y(n24) );
  sg13g2_nand2_2 U25 ( .A(G72), .B(n6), .Y(n23) );
  sg13g2_nor4_2 U26 ( .A(\DFF_2/D ), .B(n10), .C(n4), .D(n2), .Y(n50) );
  sg13g2_nor2_2 U27 ( .A(n21), .B(n22), .Y(n37) );
  sg13g2_nand2_2 U28 ( .A(G73), .B(n19), .Y(n22) );
  sg13g2_nand2_2 U29 ( .A(G74), .B(n3), .Y(n21) );
  ...
  sg13g2_inv_2 U49 ( .A(n35), .Y(\DFF_4/D ) );
  sg13g2_inv_2 U50 ( .A(G89BF), .Y(n12) );
  sg13g2_inv_2 U51 ( .A(n26), .Y(n13) );
  sg13g2_inv_2 U52 ( .A(n24), .Y(n14) );
  sg13g2_inv_2 U53 ( .A(n22), .Y(n15) );
  ...
  sg13g2_o21ai_1 U59 ( .A1(n3), .A2(n22), .B1(n21), .Y(\DFF_9/D ) );
  sg13g2_nand2b_1 U60 ( .A_N(n21), .B(G30), .Y(G95BF) );
  sg13g2_o21ai_1 U61 ( .A1(n6), .A2(n24), .B1(n23), .Y(\DFF_7/D ) );
  sg13g2_nand2b_1 U62 ( .A_N(n23), .B(G32), .Y(G97BF) );
  sg13g2_o21ai_1 U63 ( .A1(n9), .A2(n26), .B1(n25), .Y(\DFF_5/D ) );
  sg13g2_nand2b_1 U64 ( .A_N(n25), .B(G34), .Y(G99BF) );
  ...
  sg13g2_a22oi_1 U70 ( .A1(n36), .A2(G10), .B1(n37), .B2(n16), .Y(n31) );
